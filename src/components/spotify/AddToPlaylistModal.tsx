            ...
            <ScrollArea className="h-64">
              {isLoading ? (
                <div className="flex items-center justify-center h-full">
                  <Loader2 className="w-6 h-6 animate-spin text-kiosk-text/50" />
                </div>
              ) : filteredPlaylists.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-kiosk-text/50">
                  ...
                  {filteredPlaylists.map((playlist) => (
                    ...
                    >
                      ...
                      <div className="flex-1 text-left min-w-0">
                        ...
                        <p className="text-xs text-kiosk-text/60">{playlist.tracksTotal} faixas</p>
                      </div>
                      {selectedId === playlist.id && (
