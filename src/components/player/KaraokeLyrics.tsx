          ...
          return (
            ...
            >
              {line.text ? (
                    ...
                    return (
                      <span
                        ...
                        className={cn(
                          ...
                          state === 'current' && 'text-nav-neon-white font-bold scale-110 drop-shadow-[0_0_8px_hsl(var(--kiosk-primary))]',
                          state === 'future' && 'text-description-visible'
                        )}
                        style={{
                ...
                <p className="text-description-visible">♪</p>
              )}
            </div>
          );
        })}
